...
- Physical relief: **−9.28 km** (deepest trench) to **+8.54 km** (planet peak, Meridia)
...
and climate story, sharper peaks and refined statistics. Continent stats
below were computed by `tools/export-v2/continent_stats.mjs`.
...
- **Elevation**: mean **2.00 km** (highest continent) · peak **8.54 km** at ~29°N (Central Massif — planet's highest point) · 39 % of its land above 2 km
...
- **Story hooks**: passes through the 8.5 km wall · salt pan oasis economies · SW river delta as port capital · NW lakeland as contested water source · subarctic northern frontier
...
- **Elevation**: mean **1.71 km** · peak **8.01 km** at ~24°S (Northern Range) · 34 % above 2 km
...
- **Story hooks**: desert caravan economies · contested oases and water rights · salt trade · Northern River as political spine · Northern Range passes between wet coast and arid interior · subtropical snowfields on the 8 km crest (dramatic, rare)
...
- **Elevation**: mean **1.09 km** (lowest continent) · peak **7.36 km** at ~2°N (Equatorial Ranges) · 15 % above 2 km
...
- **Story hooks**: tropical maritime gateway cultures · equatorial highland peoples under 7 km snow summits on the equator · interior dry basin pastoralists · the southern cape route around the Cordillera's eastern end · easy contact with Meridia across the warm Equatorial Western Sea
...
- **Elevation**: mean **1.50 km** · peak **7.32 km** at ~60°N (Eastern Range / Northern Ice Highlands) · 29 % above 2 km
...
- **Story character**: the only continent defined entirely by cold — not by low relief (it is high ground, mean 1.5 km) but by latitude. Sparse, seasonal, materially distinct from all other continents. A different relationship with land, time, and survival.
...
**28 % of land lies above 2 km.** Himalaya-class fronts on every continent —
including an 8.5 km wall in the subtropics and 7 km summits on the equator.
Passes through these walls are history-defining chokepoints. Glacial
U-valleys, sharpened ridges, permanent snowfields.
...
| Planet peak | 8.54 km (Meridia, Central Massif, ~29°N) |
| Deepest ocean | −9.28 km |
| Continental peaks | Sirocca 8.01 · Selvana 7.36 · Borea 7.32 km |
