...
| 10 | [`10_SELVANAN_TROPICAL_NORTH.md`](10_SELVANAN_TROPICAL_NORTH.md) | **V1a**, the planet's most productive province (NPP 1,578) and the far side of doc 09's crossing — with the lowest annual temperature range measured anywhere (2.3 °C), a southern boundary that turns out to be a ruler rather than an ecology, all its real structure vertical in V2's sky-islands, and a landing beach drier than the desert the peoples left | **done** |
| 11+ | *Regional ecologies* | Next: **M4**, where most of Meridia's people actually live (doc 09), or **B2**, which doc 07 runs up a debt to. **V2** needs its own document and cannot have one until doc 00 §2.2's tropical-alpine data caveat is resolved | planned |
