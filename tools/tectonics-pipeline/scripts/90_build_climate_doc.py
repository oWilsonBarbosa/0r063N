...
(`tools/tectonics-pipeline/history/paleoclimate.yaml`), producing Köppen-style climate maps,
...
```bash
python3 tools/tectonics-pipeline/scripts/80_paleoclimate.py   # compute + calibrate + cache
python3 tools/tectonics-pipeline/scripts/85_render_climate.py # maps + curve figures
python3 tools/tectonics-pipeline/scripts/90_build_climate_doc.py
```
